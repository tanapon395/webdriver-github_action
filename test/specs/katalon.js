...
describe('Automated Test Case', () =>  {
	...
	it('Search Google Chrome', async () => {
        ...
        await expect(browser).toHaveTitle('เรียน Software Engineering แล้ว Coding ไม่ได้ ถือว่าไม่ประสบความสำเร็จในการเรียนจริงหรือ ? | by Yok • Rawisara | Artisan Digital | Medium');
	});
...
// 		expect( $('#403c')).toHaveTextContaining(`เรียน Software Engineering แล้ว Coding ไม่ได้ ถือว่าไม่ประสบความสำเร็จในการเรียนจริงหรือ ?`);
// 	});
